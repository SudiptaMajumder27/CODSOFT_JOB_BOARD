        ...
        {filteredJobPosts.map((item) => (
          <div key={item._id}>
            ...
            <Link to={`/JobDetails/${item._id}`}>
              <button className="mt-4 md:ml-20 btn btn-accent btn-outline bg-base-100 w-96 shadow-xl hover:scale-105 duration-200 dark:bg-slate-900 dark:text-white dark:border">
                View Details
              </button>
            </Link>
