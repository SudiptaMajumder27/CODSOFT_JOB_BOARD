...
function Navbar() {
  ...
  useEffect(()=>{
    ...
    return (
    <>
<div className={` max-w-screen-3xl fixed top-0 left-0 right-5 z-50 dark:bg-slate-900 dark:text-white fixed ${
  ...
  <div>
    ...
    <ul
      ...
      <li>
        <a>Pages</a>
        <ul className="p-2">
          <li><a>Internship Listing</a></li>
          <li><a>Job Listing</a></li>
  ...
  <ul className="menu menu-horizontal px-1">
    ...
    <li>
      <details>
        ...
        <ul className="p-2">
        <li><a href="/InternshipListing" >Internship Listing</a></li>
...
<label className="input input-bordered flex items-center gap-2 px-3 py-2 rounded-md md:small-hide dark:bg-slate-900 dark:text-white ">
